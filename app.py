...
if not master_df.empty:
    ...
    col_17seg_name = (
        ...
        else ("17seg_name" if "17seg_name" in master_df.columns else "17seg")
    )
            ...
            try:
                ...
                for ticker in chunk_tickers:
                    ...
                    for idx, row in recent_history.iterrows():
                        ...
                        trading_value_hyakuman = int(round((close_price * daily_volume) / 1_000_000))
                        ...
                        if turnover_rate >= threshold_percent:
                            ...
                            res_item = {
                                ...
                                "信用買残（株）": f"{int(margin_buy):,}" if margin_buy > 0 else "0",
                                "信用売残（株）": f"{int(margin_sell):,}" if margin_sell > 0 else "0",
